...
def run_angelina():
    ...
    if 'play' in command:
        ...
        talk('you really want to shutdown your computer')
        command = take_command()
        ...
        if 'fine' in ans_take_from_user_how_are_you or 'happy' in ans_take_from_user_how_are_you or 'okey' in ans_take_from_user_how_are_you:
            ...
            talk('oh sorry..')
    elif 'make you' in command or 'created you' in command or 'develop you' in command or 'makes you' in command:
...
if __name__ == "__main__":
    ...
    if videoTester.live()!= 1:
        talk("Unauthorized Access . face not matched")
        exit(0)
    print("Authorized Access . face Matched")
    talk("Authorized Access . face Matched")
